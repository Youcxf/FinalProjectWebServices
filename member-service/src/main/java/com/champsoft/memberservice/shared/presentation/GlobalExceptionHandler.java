...
import com.champsoft.memberservice.member.application.MemberRequestValidationException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ConstraintViolationException.class, MemberRequestValidationException.class})
