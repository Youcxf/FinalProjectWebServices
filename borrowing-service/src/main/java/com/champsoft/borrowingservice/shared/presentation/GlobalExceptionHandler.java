...
import com.champsoft.borrowingservice.borrowing.application.BorrowingRequestValidationException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ConstraintViolationException.class, BorrowingRequestValidationException.class})
    ...
    public ResponseEntity<ApiErrorResponse> handleMalformedJson(HttpMessageNotReadableException exception) {
        return build(HttpStatus.BAD_REQUEST, "Malformed JSON request", List.of());
    }
